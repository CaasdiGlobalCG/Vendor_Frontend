    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-surface rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="p-6">
          ...
          {error && (
            <div className="mb-4 p-3 bg-danger/10 text-danger rounded-lg text-sm flex items-start">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-info focus:border-transparent"
                required
              />
            ...
            <div className="flex justify-end space-x-3">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 border border-line rounded-lg text-ink hover:bg-canvas"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-4 py-2 bg-info text-white rounded-lg hover:bg-info flex items-center"
              >
