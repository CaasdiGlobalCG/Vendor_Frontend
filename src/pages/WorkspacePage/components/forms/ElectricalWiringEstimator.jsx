    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex justify-between items-center">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Configure Electrical Wiring</h3>
            <p className="text-sm text-gray-600 mt-1">Enter load points & wire run distances</p>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="border-t border-gray-200 pt-4">
            <p className="text-sm font-medium text-gray-700 mb-3">Rooms & Load Points (per room)</p>
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label htmlFor="numRooms" className="block text-xs font-medium text-gray-700">No. of Rooms</label>
                <input
              ...
              <div>
                <label htmlFor="lightPoints" className="block text-xs font-medium text-gray-700">Light Points</label>
                <input
              ...
              <div>
                <label htmlFor="fanPoints" className="block text-xs font-medium text-gray-700">Fan Points</label>
                <input
              ...
              <div>
                <label htmlFor="socketPoints" className="block text-xs font-medium text-gray-700">Socket Points</label>
                <input
              ...
              <div>
                <label htmlFor="switchPoints" className="block text-xs font-medium text-gray-700">Switch Points</label>
                <input
              ...
              <div>
                <label htmlFor="avgDistance" className="block text-xs font-medium text-gray-700">Avg Run/Point ({unit})</label>
                <input
                  ...
                  className="w-full px-2 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-600 mt-1">Distance from board to point</p>
              </div>
            </div>
          </div>
          ...
          {/* Wire & Conduit */}
          <div className="border-t border-gray-200 pt-4">
            <p className="text-sm font-medium text-gray-700 mb-3">Wire & Conduit</p>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="wireGauge" className="block text-xs font-medium text-gray-700">Wire Gauge (sq mm)</label>
                <select
              ...
              <div>
                <label htmlFor="conduitPercent" className="block text-xs font-medium text-gray-700">Concealed Conduit (%)</label>
                <input
                  ...
                  className="w-full px-2 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-600 mt-1">% of wiring run inside conduit</p>
              </div>
            </div>
          </div>
        ...
        {results && (
          <div className="p-6 space-y-4">
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
              <p className="text-sm text-gray-600">Total Load Points</p>
              <p className="text-3xl font-bold text-blue-600">{results.totalPoints}</p>
              <p className="text-xs text-gray-600 mt-1">across {results.numRooms} room{results.numRooms > 1 ? 's' : ''}</p>
            </div>

            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-gray-50 p-3 border-b font-bold text-sm text-gray-900">Points per Room</div>
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-gray-50 p-3 border-b font-bold text-sm text-gray-900">Wire Required</div>
              <div className="p-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between font-bold">
                  <span>Coils ({WIRE_COIL_LENGTH} m each)</span><span className="text-green-600">{results.coilsRequired}</span>
                </div>
              </div>
            </div>

            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="bg-gray-50 p-3 border-b font-bold text-sm text-gray-900">Conduit Required</div>
              <div className="p-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between font-bold">
                  <span>Pipes ({CONDUIT_LENGTH_M} m each)</span><span className="text-green-600">{results.conduitPipes}</span>
                </div>
              </div>
            </div>
    ...
    <div className="w-full bg-white rounded-lg shadow-lg p-6">
      {!results ? (
        <div className="space-y-4">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Electrical Wiring Estimator</h3>
            <p className="text-sm text-gray-600 mt-1">Estimate wire coils & conduit for load points</p>
          </div>
          <button
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-blue-50 border-2 border-blue-200 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-blue-600">{results.totalPoints}</p>
              <p className="text-xs text-gray-600">{results.numRooms} room{results.numRooms > 1 ? 's' : ''}</p>
              <button
            ...
            <div className="bg-gray-50 border-2 border-gray-200 p-4 rounded-lg">
              <p className="text-xs text-gray-600 mb-1">Wire Gauge</p>
              <p className="text-2xl font-bold text-gray-900">{results.wireGauge}</p>
              <p className="text-xs text-gray-600">sq mm</p>
            </div>

            <div className="bg-blue-50 border-2 border-blue-200 p-4 rounded-lg">
              <p className="text-xs text-gray-600 mb-1">Wire Required</p>
              <p className="text-2xl font-bold text-blue-600">{results.totalWireLength}</p>
              <p className="text-xs text-gray-600">m ({results.coilsRequired} coils)</p>
            </div>

            <div className="bg-green-50 border-2 border-green-200 p-4 rounded-lg">
              <p className="text-xs text-gray-600 mb-1">Conduit</p>
              <p className="text-2xl font-bold text-green-600">{results.conduitLength}</p>
              <p className="text-xs text-gray-600">m ({results.conduitPipes} pipes)</p>
            </div>
          </div>
