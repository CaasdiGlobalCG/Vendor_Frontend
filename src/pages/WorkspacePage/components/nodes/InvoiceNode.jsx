...
import { FileText, Plus, Trash2, Edit2, Save, Send, Clock, User, Calendar } from 'lucide-react';
    ...
    <div className={`bg-surface rounded-lg  border-2 ${selected ? 'border-info' : 'border-line'} p-4 min-w-[320px]`}>
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-ink">Tax Invoice</span>
        </div>
      ...
      {isEditing ? (
        <div className="space-y-3">
          <div>
            <label className="block text-sm font-medium text-ink mb-1">Invoice Number</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-sm font-medium text-ink mb-1">Invoice Date</label>
              <input
                type="date"
        ...
        <div className="space-y-2">
          <div className="text-sm text-dim">
            <span className="font-medium">Invoice:</span> {formData.invoiceNumber || 'Not set'}
          </div>
          <div className="text-sm text-dim">
