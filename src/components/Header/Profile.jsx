...
export const Profile = () => {
    ...
    return (
        <div className="min-h-screen bg-canvas font-sans">
            <section className="bg-black text-white rounded-xl p-4 relative rounded-b-lg" style={{ height: "200px" }}>
                    ...
                    <div className="flex justify-center pt-6">
                      <div className="bg-surface rounded-full overflow-hidden flex ">
                        <Link to="/vendor-home">
                          <button className="text-ink px-6 py-2 hover:bg-surface-hover">
                            Portfolio
                          </button>
                        </Link>
                        ...
                        <Link to="/userproject">
                        <button
                          className="bg-cta text-cta-foreground px-6 py-2 rounded-full"
                        >
                          Projects
                        </button>
                        </Link>
                        <Link to={"/userproduct"}>
                        <button
                          className="text-ink px-6 py-2 hover:bg-surface-hover"
                        >
                          Products
                        </button></Link>
                      </div>
                ...
                <div className="absolute flex flex-col md:flex-row gap-4 p-4" style={{ top: '30%' }}>
                    <section className="w-full md:w-1/3 bg-surface rounded-lg  p-6">
                              <div className="lg:col-span-1 w-full lg:sticky lg:top-8">
                                              <div className="bg-surface rounded-lg  p-6 flex flex-col items-center mx-auto" style={{ maxWidth: '350px' }}>
                                                  {/* Profile Image */}
                                                  ...
                                                  {/* Profile Name & ID */}
                                                  <h1 className="text-xl lg:text-2xl font-bold text-ink mt-2 text-center">{profileData.name}</h1>
                                                  <p className="text-dim mb-4 text-center">{profileData.vendorId}</p>
                                                  {/* Profile Details */}
                                                  <div className="w-full space-y-4 mt-4 text-left">
                                                      <div className="flex items-start gap-3">
                                                          <div className="w-6 flex-shrink-0 text-ink pt-1"><BuildingIcon /></div>
                                                          <div><p className="text-sm text-dim leading-tight">Company name</p><p className="font-medium">{profileData.companyName}</p></div>
                                                      </div>
                                                      <div className="flex items-start gap-3">
                                                          <div className="w-6 flex-shrink-0 text-ink pt-1"><Phone className="h-5 w-5" /></div>
                                                          <div><p className="text-sm text-dim leading-tight">Phone</p><p className="font-medium">{profileData.phone}</p></div>
                                                      </div>
                                                      <div className="flex items-start gap-3">
                                                          <div className="w-6 flex-shrink-0 text-ink pt-1"><MapPin className="h-5 w-5" /></div>
                                                          <div><p className="text-sm text-dim leading-tight">Location</p><p className="font-medium">{profileData.location}</p></div>
                                                      </div>
                                                      <div className="flex items-start gap-3">
                                                          <div className="w-6 flex-shrink-0 text-ink pt-1"><Mail className="h-5 w-5" /></div>
                                                          <div><p className="text-sm text-dim leading-tight">Email</p><p className="font-medium">{profileData.email}</p></div>
                                                      </div>
                                                  </div>
                                                  {/* Edit Profile Button */}
                                                  <button
                                                      onClick={handleProfileEditClick}
                                                      className="w-full mt-6 bg-black text-white py-2 px-4 rounded-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ink transition-opacity"
                                                  >
                                                      Edit Profile
                                                  </button>
                                              </div>
