      ...
      <div className="relative w-full md:w-2/3">
        ...
        {showFieldWarning && (
          <div className="absolute -top-12 left-0 right-0 z-50 flex justify-start">
            <div className="bg-danger text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap shadow-lg animate-pulse">
                  ...
                  <label className={`cursor-pointer border-2 border-dashed rounded px-4 py-3 text-sm transition-colors block ${
                    ...
                    {ocrProcessing ? (
                      <div className="space-y-3">
                        ...
                        {pendingChequeFile && (
                          <div className="flex items-center gap-2 text-info ml-7">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {formData.blankCheque.uploading ? (
                              ...
                              <p className="text-xs text-success">✓ Successfully uploaded and processed</p>
                            )}
                          </div>
                          <button
                            type="button"
                            ...
                            className="text-danger text-xs hover:text-danger font-medium"
                          >
                            Remove
                          </button>
                        </div>
